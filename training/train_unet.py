...
def train_unet(data_dir, num_imgs_in_tif=1,
               expand_data=False, patch_shape=(256, 256),
               test_size=0.1, batch_size=16,
               epochs=100, lr=0.0004, bias=False,
               model_name='unet.pt', basedir='save_models/'
               ):
    ...
    model = UNet(input_size=patch_shape[0], bias=bias)
