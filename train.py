...
parser.add_argument("--model", help="choose the model to be trained", default="n2v")
...
parser.add_argument("--expandData", help="whether to expand data by averaging 2,4,8,16 raw images", default=False)
...
parser.add_argument("--stepsize", help="training step size to reduce learning rate", default=50)
...
config_dict = {'data_dir': args.datadir, 'num_imgs_in_tif': args.numImgInTif,
